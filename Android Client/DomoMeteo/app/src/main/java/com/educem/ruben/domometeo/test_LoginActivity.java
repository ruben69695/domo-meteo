...
/**
 * A LoginActivity screen that offers LoginActivity via email/password.
 */
public class test_LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(test_LoginActivity.this,
